		...
		_onSearchFieldLiveChange: function (oEvent) {
			...
			return new Promise(function (fnResolve) {
				...
				if (sQuery && sQuery.length > 0) {
					...
					var iQuery = parseFloat(sQuery);
					if (!isNaN(iQuery)) {
						aFilters.push(new sap.ui.model.Filter("Time", sap.ui.model.FilterOperator.EQ, sQuery));
					}

					aFilters.push(new sap.ui.model.Filter("TUnits", sap.ui.model.FilterOperator.Contains, sQuery));
